var vm = new Vue({	
	...
	data:{
		...
		Tecnologias: [
			{id: 0, nombre: ' Vue.js', entradas: 18, imagen: 'Resources/img/Lenguajes/vue.png'},
			{id: 1, nombre: ' Git / GitHub', entradas: 0, imagen: 'Resources/img/Lenguajes/Git.png'},
			{id: 2, nombre: ' Linux Comandos Basicos', entradas: 7, imagen: 'Resources/img/Lenguajes/ubuntu.png'},
			{id: 3, nombre: ' SQL (Structured Query Language)', entradas: 10, imagen: 'Resources/img/Lenguajes/sql.png'}
		],


		ItemVue: [
			{id: 0, imagen: 'Resources/img/Lenguajes/vue.png', titulo: 'Instanciar Vue.js', enlace: 'https://github.com/AdrianLovo/NotasCodeVue.js/tree/master/01-Instancia%20Vue'},
			{id: 1, imagen: 'Resources/img/Lenguajes/vue.png', titulo: 'Metodos', enlace: 'https://github.com/AdrianLovo/NotasCodeVue.js/tree/master/02-Metodos%20Vue'},
			{id: 2, imagen: 'Resources/img/Lenguajes/vue.png', titulo: 'Directiva v-show', enlace: 'https://github.com/AdrianLovo/NotasCodeVue.js/tree/master/03-Directiva%20v-show'},
			{id: 3, imagen: 'Resources/img/Lenguajes/vue.png', titulo: 'Directiva v-if v-else', enlace: 'https://github.com/AdrianLovo/NotasCodeVue.js/tree/master/04-Directiva%20v-if%20v-else'},
			{id: 4, imagen: 'Resources/img/Lenguajes/vue.png', titulo: 'Directiva v-else-if', enlace: 'https://github.com/AdrianLovo/NotasCodeVue.js/tree/master/05-Directiva%20v-if-else-if'},
			{id: 5, imagen: 'Resources/img/Lenguajes/vue.png', titulo: 'Directiva v-for', enlace: 'https://github.com/AdrianLovo/NotasCodeVue.js/tree/master/06-Directiva%20v-for'},
			{id: 6, imagen: 'Resources/img/Lenguajes/vue.png', titulo: 'Directiva v-text v-html', enlace: 'https://github.com/AdrianLovo/NotasCodeVue.js/tree/master/07-Directiva%20v-text%20v-html'},
			{id: 7, imagen: 'Resources/img/Lenguajes/vue.png', titulo: 'Directiva v-bind', enlace: 'https://github.com/AdrianLovo/NotasCodeVue.js/tree/master/08-Directiva%20v-bind'},
			{id: 8, imagen: 'Resources/img/Lenguajes/vue.png', titulo: 'Componentes', enlace: 'https://github.com/AdrianLovo/NotasCodeVue.js/tree/master/09-Componentes'},
			{id: 9, imagen: 'Resources/img/Lenguajes/vue.png', titulo: 'Componentes . Props', enlace: 'https://github.com/AdrianLovo/NotasCodeVue.js/tree/master/10-Componentes%20.%20Props'},
			{id: 10, imagen: 'Resources/img/Lenguajes/vue.png', titulo: 'Transiciones', enlace: 'https://github.com/AdrianLovo/NotasCodeVue.js/tree/master/11-Transiciones'},
			{id: 11, imagen: 'Resources/img/Lenguajes/vue.png', titulo: 'Filtros', enlace: 'https://github.com/AdrianLovo/NotasCodeVue.js/tree/master/12-Filtros'},
			{id: 12, imagen: 'Resources/img/Lenguajes/vue.png', titulo: 'Tareas Computadas', enlace: 'https://github.com/AdrianLovo/NotasCodeVue.js/tree/master/13-Tareas%20Computadas'},
			{id: 13, imagen: 'Resources/img/Lenguajes/vue.png', titulo: 'Vue con AJAX', enlace: 'https://github.com/AdrianLovo/NotasCodeVue.js/tree/master/14-Vue%20con%20AJAX'},
			{id: 14, imagen: 'Resources/img/Lenguajes/vue.png', titulo: 'Vue Cli', enlace: 'https://github.com/AdrianLovo/NotasCodeVue.js/tree/master/15-Vue%20Cli'},
			{id: 15, imagen: 'Resources/img/Lenguajes/vue.png', titulo: 'Directiva V-once', enlace: 'https://github.com/AdrianLovo/NotasCodeVue.js/tree/master/16-Directiva%20V-once'},
			{id: 16, imagen: 'Resources/img/Lenguajes/vue.png', titulo: 'Escuchando Eventos con Vue', enlace: 'https://github.com/AdrianLovo/NotasCodeVue.js/tree/master/17-Escuchando%20Eventos%20con%20Vue'},
			{id: 17, imagen: 'Resources/img/Lenguajes/vue.png', titulo: 'Observable', enlace: 'https://github.com/AdrianLovo/NotasCodeVue.js/tree/master/18-Observable'},
		],
		...
		ItemLinux: [
			{id: 0, imagen: 'Resources/img/Lenguajes/ubuntu.png', titulo: 'Navegación entre archivos y listado de archivos'},
			{id: 1, imagen: 'Resources/img/Lenguajes/ubuntu.png', titulo: 'Creación de Directorios , mover, copiar y eliminar archivos'},
			{id: 2, imagen: 'Resources/img/Lenguajes/ubuntu.png', titulo: 'Links (Apuntadores)'},
			{id: 3, imagen: 'Resources/img/Lenguajes/ubuntu.png', titulo: 'Otros Comandos'},
			{id: 4, imagen: 'Resources/img/Lenguajes/ubuntu.png', titulo: 'Monitoreo de procesos'},
			{id: 5, imagen: 'Resources/img/Lenguajes/ubuntu.png', titulo: 'Busqueda de contenido'},
			{id: 6, imagen: 'Resources/img/Lenguajes/ubuntu.png', titulo: 'Crontab'},
		],
